...
MIRCO::InputParameters::InputParameters(const std::string& inputFileName)
{
  ...
  if (Utils::get_bool(root, "RandomTopologyFlag"))
  {
    *this = InputParameters(Utils::get_double(matParams, "E1"), Utils::get_double(matParams, "E2"),
        ...
        Utils::get_double(geoParams, "HurstExponent"), Utils::get_int(root, "MaxIteration"), Utils::get_bool(root, "WarmStartingFlag"), Utils::get_bool(root, "PressureGreenFunFlag"), Utils::get_optional_int(root, "RandomGeneratorSeed"));
  }
  else
  {
